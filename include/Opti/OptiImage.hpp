...
#ifndef REPLACE_WITH_YOUR_PROJECT_NAME_OPTIIMAGE_HPP
#define REPLACE_WITH_YOUR_PROJECT_NAME_OPTIIMAGE_HPP
 ...
 */
class OptiImage : public Core::Drawable {
public:
    /**
     ...
     */
    explicit OptiImage(const std::string &filepath);
...
#endif //REPLACE_WITH_YOUR_PROJECT_NAME_OPTIIMAGE_HPP